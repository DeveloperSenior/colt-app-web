...
public class ColtConstant implements Serializable{
	...
	public static final String JDNI_CONNECTION = "java:jboss/ParrotDS";
	public static final String JDNI_EAGLE_CONNECTION = "java:jboss/EagleDS";
	public static final String CONF_S = "S";
	public static final String CONF_N = "N";
	public static final String PACKAGE = "PACKAGE.APP";
	public static final String HEADER_TOKEN = "secureToken";
